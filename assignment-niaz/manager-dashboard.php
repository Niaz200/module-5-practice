...
<div class="p-4 sm:ml-64">
    <div class="p-4 rounded-lg dark:border-gray-700">
        ...
        <div class="grid grid-cols-4 gap-4 mb-4">
            ...
            <div class="flex flex-col items-center justify-center h-24 rounded bg-red-500 dark:bg-gray-800">
            ...
            <div class="flex flex-col items-center justify-center h-24 rounded bg-teal-500dark:bg-gray-800">
